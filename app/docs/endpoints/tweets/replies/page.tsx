...
export default function TweetRepliesPage() {
  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        description="Get replies for a specific tweet ID"
        endpoint="GET /api/v1/twitter/tweets/:tweetId/replies"
        badge="GET"
      />
...
print(data)`}
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="pb-0">
            <div className="flex justify-between items-center">
              <CardTitle className="text-white">Tweet Replies</CardTitle>
  ...
  "message": "Replies not found"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/tweets/:tweetId/replies"
        method="GET"
        parameters={[
          {
            name: "tweetId",
