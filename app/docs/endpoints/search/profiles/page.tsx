  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        description="Search for Twitter profiles with cursor pagination"
        endpoint="GET /api/v1/twitter/users/search_profiles"
        badge="GET"
      />
...
print(data)`}
  ...
  "message": "Invalid or expired API key"
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="pb-2">
            <div className="flex justify-between items-center">
              <CardTitle className="text-white text-base">400 Bad Request</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <ResponseExample
  ...
  "message": "Query parameter is required"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/users/search_profiles"
        method="GET"
        parameters={[
          {
            name: "query",
