  ...
  return (
    <div className="container  px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        description="Get accounts that a specific Twitter user is following"
        endpoint="GET /api/v1/twitter/users/following/:userId"
        badge="GET"
      />
        ...
        <ParameterTable
          parameters={[
            ...
            },
            {
              ...
              type: "number",
              required: false,
              description: "Maximum number of following accounts to return",
              defaultValue: "20",
            },
            {
              name: "cursor",
...
print(data)`}
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="pb-0">
            <div className="flex justify-between items-center">
              <CardTitle className="text-white">User Following</CardTitle>
  ...
  "message": "User not found"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/users/following/:userId"
        method="GET"
        parameters={[
          {
            name: "userId",
