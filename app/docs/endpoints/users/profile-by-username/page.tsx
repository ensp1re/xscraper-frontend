  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        description="Get Twitter profile information by username"
...
-H "X-API-Key: <your-api-key>"`}
          ...
          <TabsContent value="javascript" className="mt-2">
            <CodeBlock
              language="javascript"
              code={`fetch('https://api.xscraper.online/api/v1/twitter/users/profile_by_username/elonmusk', {
method: 'GET',
headers: {
...
url = "https://api.xscraper.online/api/v1/twitter/users/profile_by_username/elonmusk"
headers = {
  "X-API-Key": "<your-api-key>"
}
...
print(data)`}
  ...
  "message": "Profile not found"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/users/profile_by_username/:username"
        method="GET"
        parameters={[
          {
            name: "username",
