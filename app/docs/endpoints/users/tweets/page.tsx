...
export default function UserTweetsPage() {
  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        description="Get tweets posted by a specific username"
        endpoint="GET /api/v1/twitter/users/tweets/:username"
        badge="GET"
      />
...
print(data)`}
  ...
  "message": "User not found"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/users/tweets/:username"
        method="GET"
        parameters={[
          {
            name: "username",
