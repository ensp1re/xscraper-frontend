...
export default function LatestTweetPage() {
  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        description="Get the latest tweet posted by a specific username"
        endpoint="GET /api/v1/twitter/users/latest_tweet/:username"
        badge="GET"
      />
        ...
        <Tabs defaultValue="curl" className="w-full">
          ...
          <TabsContent value="curl" className="mt-2">
            <CodeBlock
              language="bash"
              code={`curl -X GET \\
"https://api.xscraper.online/api/v1/twitter/users/latest_tweet/elonmusk" \\
-H "X-API-Key: <your-api-key>"`}
          ...
          <TabsContent value="javascript" className="mt-2">
            <CodeBlock
              language="javascript"
              code={`fetch('https://api.xscraper.online/api/v1/twitter/users/latest_tweet/elonmusk', {
method: 'GET',
headers: {
...
url = "https://api.xscraper.online/api/v1/twitter/users/latest_tweet/elonmusk"
headers = {
  "X-API-Key": "<your-api-key>"
}
...
print(data)`}
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="pb-0">
            <div className="flex justify-between items-center">
              <CardTitle className="text-white">Latest Tweet</CardTitle>
  ...
  "message": "User not found or has no tweets"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/users/latest_tweet/:username"
        method="GET"
        parameters={[
          {
            name: "username",
