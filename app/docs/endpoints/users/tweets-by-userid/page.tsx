...
-H "X-API-Key: <your-api-key>"`}
          ...
          <TabsContent value="javascript" className="mt-2">
            <CodeBlock
              language="javascript"
              code={`fetch('https://api.xscraper.xyz/api/v1/twitter/users/tweets_by_user_id/44196397?maxTweets=10', {
method: 'GET',
headers: {
...
url = "https://api.xscraper.xyz/api/v1/twitter/users/tweets_by_user_id/44196397"
params = {
  "maxTweets": 10
}
headers = {
