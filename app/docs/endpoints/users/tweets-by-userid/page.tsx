...
export default function TweetsByUserIdPage() {
  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        description="Get tweets posted by a specific user ID"
        endpoint="GET /api/v1/twitter/users/tweets_by_user_id/:userId"
        badge="GET"
      />
        ...
        <Tabs defaultValue="curl" className="w-full">
          ...
          <TabsContent value="curl" className="mt-2">
            <CodeBlock
              language="bash"
              code={`curl -X GET \\
"https://api.xscraper.online/api/v1/twitter/users/tweets_by_user_id/44196397?maxTweets=10" \\
-H "X-API-Key: <your-api-key>"`}
          ...
          <TabsContent value="javascript" className="mt-2">
            <CodeBlock
              language="javascript"
              code={`fetch('https://api.xscraper.online/api/v1/twitter/users/tweets_by_user_id/44196397?maxTweets=10', {
method: 'GET',
headers: {
...
url = "https://api.xscraper.online/api/v1/twitter/users/tweets_by_user_id/44196397"
params = {
  "maxTweets": 10
}
headers = {
...
print(data)`}
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="pb-0">
            <div className="flex justify-between items-center">
              <CardTitle className="text-white">User Tweets</CardTitle>
  ...
  "message": "User not found"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/users/tweets_by_user_id/:userId"
        method="GET"
        parameters={[
          {
            name: "userId",
