...
export default function UserIdPage() {
  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        title="Get User ID"
        description="Resolve a Twitter username to a numeric user ID"
        endpoint="GET /api/v1/twitter/users/user_id/:username"
        badge="GET"
      />
        ...
        <Tabs defaultValue="curl" className="w-full">
          ...
          <TabsContent value="curl" className="mt-2">
            <CodeBlock
              language="bash"
              code={`curl -X GET \\
  https://api.xscraper.online/api/v1/twitter/users/user_id/elonmusk \\
  -H "X-API-Key: <your-api-key>"`}
          ...
          <TabsContent value="javascript" className="mt-2">
            <CodeBlock
              language="javascript"
              code={`fetch('https://api.xscraper.online/api/v1/twitter/users/user_id/elonmusk', {
  method: 'GET',
  headers: {
...
url = "https://api.xscraper.online/api/v1/twitter/users/user_id/elonmusk"
headers = {
    "X-API-Key": "<your-api-key>"
}
...
curl_setopt_array($curl, [
  CURLOPT_URL => "https://api.xscraper.online/api/v1/twitter/users/user_id/elonmusk",
...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://api.xscraper.online/api/v1/twitter/users/user_id/elonmusk"))
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="pb-0">
            <div className="flex justify-between items-center">
              <CardTitle className="text-white">User ID</CardTitle>
  ...
  "statusCode": 401,
  "timestamp": "2025-04-19T15:49:28.824Z",
  "path": "/api/v1/twitter/users/user_id/elonmusk",
  "method": "GET",
  ...
  "statusCode": 404,
  "timestamp": "2025-04-19T15:49:28.824Z",
  "path": "/api/v1/twitter/users/user_id/nonexistentuser",
  "method": "GET",
  "message": "User not found"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/users/user_id/:username"
        method="GET"
        parameters={[
          {
            name: "username",
