  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        description="Get tweets liked by a specific Twitter user"
        endpoint="GET /api/v1/twitter/users/likes/:username"
        badge="GET"
      />
...
public class Main {
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="pb-0">
            <div className="flex justify-between items-center">
              <CardTitle className="text-white">User Likes</CardTitle>
  ...
  "message": "User not found"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/users/likes/:username"
        method="GET"
        parameters={[
          {
            name: "username",
