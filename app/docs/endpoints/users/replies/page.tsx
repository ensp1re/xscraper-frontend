  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        description="Get replies posted by a specific username"
        endpoint="GET /api/v1/twitter/users/replies/:username"
        badge="GET"
      />
...
print(data)`}
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="pb-0">
            <div className="flex justify-between items-center">
              <CardTitle className="text-white">User Replies</CardTitle>
  ...
  "message": "User not found"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/users/replies/:username"
        method="GET"
        parameters={[
          {
            name: "username",
