  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        description="Get Twitter profile information by user ID"
        endpoint="GET /api/v1/twitter/users/profile_by_userid/:userId"
        badge="GET"
      />
...
print(data)`}
  ...
  "statusCode": 401,
  "timestamp": "2025-04-19T15:49:28.824Z",
  "path": "/api/v1/twitter/users/profile_by_userid/44196397",
  "method": "GET",
  ...
  "statusCode": 404,
  "timestamp": "2025-04-19T15:49:28.824Z",
  "path": "/api/v1/twitter/users/profile_by_userid/nonexistentid",
  "method": "GET",
  "message": "Profile not found"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/users/profile_by_userid/:userId"
        method="GET"
        parameters={[
          {
            name: "userId",
