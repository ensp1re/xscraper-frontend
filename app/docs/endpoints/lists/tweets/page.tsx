...
export default function ListTweetsPage() {
  ...
  return (
    <div className="container px-4 py-6 md:py-10 max-w-5xl">
      <EndpointHeader
        ...
        endpoint="GET /api/v1/twitter/lists/:listId/tweets"
        badge="GET"
      />
...
print(data)`}
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="pb-0">
            <div className="flex justify-between items-center">
              <CardTitle className="text-white">List Tweets</CardTitle>
    ...
    "tweets": [
      {
        ...
        "text": "This is a tweet from a list",
        "username": "elonmusk",
        "name": "Elon Musk",
        "likes": 50000,
        "replies": 5000,
  ...
  "statusCode": 401,
  "timestamp": "2025-04-19T15:49:28.824Z",
  "path": "/api/v1/twitter/lists/1580661677227986944/tweets",
  "method": "GET",
  "message": "Invalid or expired API key"
      ...
      <TryItDialog
        ...
        endpoint="/api/v1/twitter/lists/:listId/tweets"
        method="GET"
        parameters={[
          {
            name: "listId",
